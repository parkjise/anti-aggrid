...
import sourceCode from './CellBorderSample.tsx?raw';
...
const CellBorderSample: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', gap: '16px' }}>
      <SampleHeader 
        title="4. Cell Border Styling (특정 셀 오른쪽 라인 색상)" description="일부 특정 컬럼이나 조건에 일치하는 셀의 우측 외곽선(Right Border) 색상과 두께를 칠해 영역을 구분합니다."
        coreFeatures={[
      ...
      />
      <div className="grid-wrapper" style={{ flex: '0 0 auto', height: '482px', padding: 0 }}><div className="ag-theme-quartz" style={{ height: '100%', width: '100%' }}>
      ...
      <SampleSourcePanel sourceCode={sourceCode} fileName="CellBorderSample.tsx" />
    </div>
  );
};
