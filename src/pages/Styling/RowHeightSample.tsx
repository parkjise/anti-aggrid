...
import sourceCode from './RowHeightSample.tsx?raw';
...
const RowHeightSample: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '16px' }}>
      <SampleHeader 
        title="3. Row & Header Height" description="그리드의 헤더(Header) 및 개별 로우(Row)의 높이를 자유롭게 조절합니다."
        coreFeatures={[
      ...
      <SampleSourcePanel sourceCode={sourceCode} fileName="RowHeightSample.tsx" />
    </div>
  );
};
